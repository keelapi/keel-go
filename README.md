...
Use the generated/reference client against the Keel API.
...
func main() {
    ...
    permit, err := client.Permits.Create(context.Background(), keel.PermitRequest{
